  ...
  if (!hasKey) {
    return (
      <section className="w-full rounded-xl border border-dashed border-[color:var(--border)] bg-[color:var(--surface-soft)] p-4">
        <h2 className="text-base font-semibold text-[color:var(--foreground)]">Settings</h2>
        <p className="mt-2 text-sm text-[color:var(--muted)]">Add a token to load settings.</p>
      </section>
    );
  }
  ...
  if (isLoading) {
    return (
      <section className="w-full rounded-xl border border-[color:var(--border)] bg-[color:var(--surface-soft)] p-4">
        <h2 className="text-base font-semibold text-[color:var(--foreground)]">Settings</h2>
        <p className="mt-2 text-sm text-[color:var(--muted)]">Loading settings...</p>
      </section>
    );
  }
